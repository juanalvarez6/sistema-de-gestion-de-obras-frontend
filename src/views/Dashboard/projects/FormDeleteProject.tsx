...
const FormDeleteProject = ({ projectId }: FormDeleteProjectProps) => {

    const [isModalOpen, setIsModalOpen] = useState(false);
    const { mutate: deleteProjectMutation, isPending, isSuccess } = useDeleteProject();
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-gray-100 p-6 rounded-lg max-w-sm">
                        <h3 className="text-lg font-medium mb-4">¿Eliminar proyecto?</h3>
